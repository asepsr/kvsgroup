...
$sql = "SELECT nik, nama, alamat, tgl_lahir, bagian, k1_join, k1_finish, k2_join, k2_finish, status";
$sql.=" FROM karyawan";
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT nik, nama, tgl_lahir, alamat, bagian, k1_join, k1_finish, k2_join, k2_finish, status";
	$sql.=" FROM karyawan";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     ...
                     <a href="update_deduction.php?id='.$row['nik'].'"  data-toggle="tooltip" title="Edit" class="btn btn-sm btn-primary"> <i class="glyphicon glyphicon-edit"></i> </a>
