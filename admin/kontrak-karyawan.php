            ...
            <section class="col-lg-12 connectedSortable">
              ...
              ?>
				 ...
				 <div class="box-header">
                  ...
                  <h3 class="box-title">Data Karyawan Yang berulang tahun <b style="color: green;">
                  <div class="box-tools pull-right">
                  </div> 
                </div>
				<div class="box-body">
                <?php
					...
					$query1="SELECT nama,tgl_lahir FROM karyawan WHERE DATE_FORMAT(tgl_lahir,'%m %d') BETWEEN DATE_FORMAT(CURDATE(),'%m %d') AND DATE_FORMAT((INTERVAL 21 DAY + CURDATE()),'%m %d') ORDER BY DATE_FORMAT(tgl_lahir,'%m %d ')";
                  ...
                  <thead>
                      <tr>
                        <th>Nama </center></th>
                        <th>Tanggal Ulang Tahun</center></th>
				   ...
				   <td><b style="color: green;"><span class="fa fa-dashboard"></span> <?php echo $data['tgl_lahir'];?></td>
                   </center></td>
                    </tr> <?php   
              } 
              ?>
