...
<?php } ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <?php $tampil1=mysqli_query($koneksi, "select * from user order by user_id desc");
            ...
            <?php $tampil2=mysqli_query($koneksi, "select * from karyawan order by nik desc");
            ...
            <?php $tampil3=mysqli_query($koneksi, "select * from absen order by id_absen desc");
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                ...
                <a href="absensi.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
	...
	$email_to = "hakkobiorichard@gmail.com";

	$email_subject = "Reminder Renewal Contract";
