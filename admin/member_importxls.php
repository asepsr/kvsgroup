...
//       membaca data (kolom ke-1 sd terakhir)
      ...
      $alamat	     = $data->val($i, 4);
      $bagian        = $data->val($i, 5); 
      $k1_join       = $data->val($i, 6);    
      $k1_finish     = $data->val($i, 7); 
      $k2_join       = $data->val($i, 8);
      $k2_finish     = $data->val($i, 9);
      $status        = $data->val($i, 10);    
 
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT INTO karyawan (nik, nama, tgl_lahir, alamat, bagian, k1_join, k1_finish, k2_join, k2_finish, status) VALUES 
                      ('$nik','$nama','$tgl_lahir','$alamat','$bagian','$k1_join','$k1_finish','$k2_join','$k2_finish','$status')";
