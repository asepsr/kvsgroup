	...
	<head>
		...
		<div class="content-wrapper">
			<section class="content-header">
				<h1>
					Data Attendance <small>HRMS</small>
				</h1>
				<ol class="breadcrumb">
				...
				<div class="row">
					<section class="col-lg-12 connectedSortable">
						...
						<div class="box-body">
							...
							?>
							<a href="Absensi_importxls.php" class="btn btn-sm btn-warning"><i class="fa fa-file"></i> Import Excel</a> <a href="absensi_exportxls.php" class="btn btn-sm btn-success"><i class="fa fa-file"></i> Export Excel</a><br /><br />
							   <div class="table">
		...
		var dataTable = $('#lookup').DataTable( {
			...
			"serverSide": true,
			"ajax":{
				url :"ajax-grid-data_record.php", // json datasource
