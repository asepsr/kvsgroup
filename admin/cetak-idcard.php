              ...
              <div class="box-primary col-lg-3 ">
                ...
                <div class="box-body">
                  <div class="form-panel">
                      <table id="example">
                      <tr>
                      <td><center><img src="image/172271logo.png" height="50" width="50"/><b>KVS GROUP</center></td>
					  </tr> 
                      <tr>
                      ...
                      <tr>
                      <td style="font-family: Arial Black; color: black; font-size: 16px;"><center>NIK : <?php echo $data['nik']; ?> </div></center></td>
                      </tr>
                      </table>
                     <br /><br /><br />
