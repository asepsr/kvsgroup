          ...
          <div class="row">
			...
			if(isset($_POST['input'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO karyawan(nik, nama, tgl_lahir, alamat, bagian, k1_join, k1_finish, k2_join, k2_finish, status, gambar)
															VALUES('$nik','$nama','$tgl_lahir','$alamat','$bagian','$k1_join','$k1_finish','$k2_join','$k2_finish','$status','$gambar')") or die(mysqli_error());
						if($insert){
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO karyawan(nik, nama, tgl_lahir, alamat, bagian, k1_join, k1_finish, k2_join, k2_finish, status, gambar) VALUES
                                      ('$nik','$nama','$tgl_lahir','$alamat','$bagian','$k1_join','$k1_finish','$k2_join','$k2_finish','$status','$gambar')";
			...
			<div class="box-body">
				<form class="form-horizontal style-form" action="input-member.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='tgl_lahir' id="tgl_lahir" placeholder='Tanggal Lahir' required />					
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Alamat</label>
						<div class="col-sm-4">
							 <textarea name="alamat" type="text" id="alamat" class="form-control" placeholder="Alamat Karyawan" autocomplete="off" required></textarea>
						</div>
					</div>
					<div class="form-group">
