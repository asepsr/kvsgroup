...
<?php } ?>
      ...
      <div class="content-wrapper">
		...
		'$desc','$progres','$washpro','$emb','$noof','$detwil',
		 ...
		 $run=mysqli_query($koneksi,$insert) or die(mysqli_error($koneksi));
			...
			<div class="box-body">
				...
				<div class="form-group">
						...
						<div class="col-sm-4">
							<input name="styleno" type="text" id="styleno" class="form-control" placeholder="styleno" autocomplete="off" required />
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Buyer</label>
						<div class="col-sm-4">
							<select id="byer" name="byer" class="form-control" required>
          ...
          <option value="Hansae Kmart">HANSAE KMART</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input name="mkt" type="text" id="mkt" class="form-control" placeholder="nama marketing" autocomplete="off" required /
						</div>
					</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='ordmk' id="ordmk" placeholder='confrm date' required />					
						</div>
					</div>
				...
				<div class="form-group">
						...
						<div class="col-sm-4">
							<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='update' id="update" placeholder='masterlist update' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Ocf Date</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='ocf' id="ocf" placeholder='ocfdate' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">BOM DATE </label>
						<div class="col-sm-4">
							<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='bom' id="bom" placeholder='bomdate' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Last Po Sew</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='posew' id="posew" placeholder='last posew' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Last Po Fab</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='pofab' id="pofab" placeholder='last po fabric' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Last Po Fin</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='pofin' id="pofin" placeholder='last po fin' required />					
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Pcd Dt</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='pcd' id="pcd" placeholder='pcd date' required />					
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Product</label>
						<div class="col-sm-4">
						<select name="produk" id="produk" required="required" >
        ...
        <option value="Shirt">SHIRT</option>
				...
				<div class="form-group">
						...
						<div class="col-sm-4">
							<input name="smv" type="text" id="smv" class="form-control" placeholder="smv" autocomplete="off" required />
						</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label"> Description </label>
						<div class="col-sm-4">
				 <textarea name="desc" type="text" id="desc" class="form-control" placeholder="description" autocomplete="off" required></textarea>
				 	</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Wash Status</label>
						<div class="col-sm-4">
						 <td><input name="wash" type="radio" id="radio" value="washing" required="required" />
        Washing 
          <input type="radio" name="wash" id="radio2" value="nonwashing" required="required" />
Non Washing 
<input name="wash" type="radio" value="specialwashing" required="required" />
Special Washing </td>
					</div>
					</div>
				<div class="form-group">
						...
						<div class="col-sm-4">
	 <textarea name="progres" type="text" id="progres" class="form-control" placeholder="spesial process" autocomplete="off" required></textarea>
				 	</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Wash Process</label>
						<div class="col-sm-4">
					<input name="washpro" type="text" id="washpro" class="form-control" placeholder="wash process" autocomplete="off" required />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fabric PO</label>
						<div class="col-sm-4">
					<input name="fabpo" type="text" id="fabpo" class="form-control" placeholder="fabric po" autocomplete="off" required />
						</div>
					</div>
						<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label"></label>
						<div class="col-sm-4">
					<select name="detwil" size="1" multiple="MULTIPLE" id="detwil">
        ...
        <option value="Twill">TWILL</option>
				...
				<div class="form-group">
						...
						<div class="col-sm-4">
						 <td><input name="emb" type="radio" id="emb" value="YES" required="required" /> YES
			<input name="noof" type="text" id="noof" class="form-control" placeholder="No.Of Embroidery Stitches" autocomplete="off" required />

          <input type="radio" name="emb" id="emb" value="NO" required="required" /> No
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Buyer PO</label>
						<div class="col-sm-4">
					<input name="byerpo" type="text" id="byerpo" class="form-control" placeholder="buyer po" autocomplete="off" required />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Color</label>
						<div class="col-sm-4">
					<input name="color" type="text" id="color" class="form-control" placeholder="color" autocomplete="off" required />
						</div>
					</div>
					<div class="form-group">
          ...
          <option value="Winter">WINTER</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
					<input name="week" type="text" id="week" class="form-control" placeholder="week delivery" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Qty Dz</label>
						<div class="col-sm-4">
					<input name="qty" type="text" id="qty" class="form-control" placeholder="qty dz" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Qty Pcs </label>
						<div class="col-sm-4">
					<input name="dz" type="text" id="dz" class="form-control" placeholder="qty pcs" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Delivery Date</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='delvdt' id="delvdt" placeholder='delivery date' required />					
						</div>
						</div> 
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Ext Date</label>
						<div class="col-sm-4">
					<input type='text' class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" name='exdt' id="exdt" placeholder='ext date' required />					
						</div>
						</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fob</label>
						<div class="col-sm-4">
					<input name="fob" type="text" id="fob" class="form-control" placeholder="fob" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">D/N</label>
						<div class="col-sm-4">
					<input name="dn" type="text" id="dn" class="form-control" placeholder="dn" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Ho Overhead </label>
						<div class="col-sm-4">
					<input name="ho" type="text" id="ho" class="form-control" placeholder="ho overhead" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">TTL Fob(+DN) Amount </label>
						<div class="col-sm-4">
					<input name="ttldn" type="text" id="ttldn" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">TTL HO-O Amount</label>
						<div class="col-sm-4">
					<input name="ttlho" type="text" id="ttlho" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">LDP</label>
						<div class="col-sm-4">
					<input name="ldp" type="text" id="ldp" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">TTL LDP Amount</label>
						<div class="col-sm-4">
					<input name="ttlldp" type="text" id="ttlldp" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>	
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fab ref </label>
						<div class="col-sm-4">
					<input name="fab" type="text" id="fab" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>			
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fty Cmp</label>
						<div class="col-sm-4">
					<input name="fty" type="text" id="fty" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
				<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Cnsp / Pcs </label>
						<div class="col-sm-4">
					<input name="cnsp" type="text" id="cnsp" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Ttl Cmp Amount</label>
						<div class="col-sm-4">
					<input name="ttlcmp" type="text" id="ttlcmp" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fab Qty(YD)</label>
						<div class="col-sm-4">
					<input name="fabqty" type="text" id="fabqty" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fab px/yd</label>
						<div class="col-sm-4">
					<input name="pxyd" type="text" id="pxyd" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fabric Amount USD </label>
						<div class="col-sm-4">
					<input name="fabusd" type="text" id="fabusd" class="form-control" placeholder="$" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Supp Name </label>
						<div class="col-sm-4">
						<select name="suppname" id="suppname" required="required" >
						<option value="0">choose</option>
        ...
        <option value="Tatfung">TATFUNG</option>
				...
				<div class="form-group">
						...
						<div class="col-sm-4">
					<input name="term" type="text" id="term" class="form-control" placeholder="term" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Fab Status </label>
						<div class="col-sm-4">
						 <td> <input name="fabstat" type="radio" value="sourch" required="required" />
        Sourch
        <input name="fabstat" type="radio" value="dropship" required="required" />
        Dropship
        <input name="fabstat" type="radio" value="nominated" required="required" />
      Nominated</label></td>
					</div>
					</div>
				<div class="form-group">
						...
						<div class="col-sm-4">
					<input name="fabtype" type="text" id="fabtype" class="form-control" placeholder="fabtype" autocomplete="off" required />
					</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 col-sm-2 control-label">Foldedd/Hanger</label>
						<div class="col-sm-4">
					<input name="hanger" type="text" id="hanger" class="form-control" placeholder="foldedd hanger" autocomplete="off" required />
					</div>
					</div>
